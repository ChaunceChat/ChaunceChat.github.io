...
maybe have creating new chat a double click functinallity (and have escape be the cancel)
Maybe have it so it shows which users are online (might need to thave a variable in the database to keep track)

for creating a new chat/server, Have a welcome message so everything gets pushed before people can start messaging
*/
